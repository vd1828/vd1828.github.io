...
<head>
    ...
    <title>Dileep Reddy Jajappagari - Professional Portfolio</title>
    ...
    <style>
        body {
            ...
            margin: 20px;
            line-height: 1.6;
           background: url('https://raw.githubusercontent.com/vd1828/vd1828.github.io/main/Background.jpg') center/cover no-repeat, linear-gradient(to right, #4cb8c4, #3cd3ad, #28a19f);
...
<body>
    ...
    <section class="transparent-bg">
        "<img src="https://raw.githubusercontent.com/vd1828/vd1828.github.io/main/Dileep.jpg" alt="Image Description" style="width: 25%; max-height: 800px; margin-bottom: 10px; margin-left: 10px; margin-right: 10px;">
    </section>
    <section>
        <p>
            Hello Everyone,<br>
